...
//<T,E> implements stx.run.type.Package.Recall<Automation,Res<T,E>,Automation>
class Implementation{
    ...
    static public function fold<T,TT,E>(self:WaiterDef<T,E>,val:T->TT,err:Err<E>->TT):ReceiverDef<TT>                 
      return inj(self)._.fold(val,err,self);
    static public function errata<T,E,EE>(self:WaiterDef<T,E>,fn:Err<E>->Err<EE>):WaiterDef<T,EE>            
