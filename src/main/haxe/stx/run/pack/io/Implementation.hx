...
class Implementation{
  ...
  static public function fold<T,TT,E>(self:IO<T,E>,v:T->TT,e:Null<TypedError<E>>->TT):UIO<TT>     return inj(self)._.fold(v,e,self);
  static public function zip<T,TT,E>(self:IO<T,E>,that:IO<TT,E>):IO<Tuple2<T,TT>,E>               return inj(self)._.zip(that,self); 
  static public function errata<T,E,EE>(self:IO<T,E>,fn:TypedError<E>->TypedError<EE>):IO<T,EE>   return inj(self)._.errata(fn,self);
